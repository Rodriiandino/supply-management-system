      ...
      <div className="flex flex-col gap-4 md:gap-8">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Cree una nueva solicitud de insumos</p>
          </div>
        </div>
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            <CardHeader>
              ...
              <CardDescription>Complete la información sobre los insumos que necesita</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="titulo">Título</Label>
                <Input id="titulo" placeholder="Ej: Materiales de oficina" required />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select required>
                    ...
                    <SelectContent>
                      <SelectItem value="oficina">Materiales de oficina</SelectItem>
                      <SelectItem value="tecnologia">Tecnología</SelectItem>
                      <SelectItem value="mobiliario">Mobiliario</SelectItem>
                      <SelectItem value="limpieza">Artículos de limpieza</SelectItem>
                      <SelectItem value="cafeteria">Insumos de cafetería</SelectItem>
