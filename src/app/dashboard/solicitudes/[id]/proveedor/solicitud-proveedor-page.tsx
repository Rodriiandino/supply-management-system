...
export default function SolicitudProveedor({ paramId }: { paramId: string }) {
  const router = useRouter()
  const [, setActiveTab] = useState('detalles')
            ...
            <div className='p-4 flex justify-between'>
              <div className='flex space-x-4'>
                ...
                >
                  <Heart
                    className={`h-6 w-6 ${
                      false ? 'text-red-500 fill-red-500' : ''
                    }`}
                  />
                </Button>
                <Button
          ...
          <div className='md:w-1/3 p-4 space-y-6'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          {solicitud.ofertas.length} ofertas
                        </p>
                      </div>
                    </div>
                    <div className='flex items-center gap-2'>
            ...
            <Card>
              <CardHeader className='pb-3'>
                ...
                <CardDescription>
                  Complete el formulario para enviar su oferta
                </CardDescription>
              </CardHeader>
                ...
                <CardContent className='space-y-4 pb-4'>
                  <div className='space-y-2'>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setOfertaForm({ ...ofertaForm, monto: e.target.value })
                      }
                      required
                    />
                  </div>
