...
export default function SolicitudPage({ paramId }: { paramId: string }) {
          ...
          <div className='md:col-span-2 space-y-6'>
              ...
              <CardContent className='space-y-4'>
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Necesitamos diversos materiales de oficina para abastecer
                    nuestras nuevas instalaciones. Requerimos papel, bolígrafos,
                    carpetas, clips, grapas, post-its y otros insumos básicos de
                    oficina. Todos los productos deben ser de buena calidad y
                    entregados en nuestra dirección principal.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Preferimos proveedores que puedan entregar todos los
                    productos en un solo pedido. La entrega debe realizarse en
                    horario de oficina (9:00 - 18:00).
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  3 proveedores han realizado ofertas
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                {[
                    ...
                    <div className='flex items-center justify-between'>
                      <div className='flex items-center gap-2'>
                        <Avatar className='h-8 w-8'>
                          <AvatarFallback>
                            {oferta.proveedor.substring(0, 2)}
                          </AvatarFallback>
                        </Avatar>
                        <div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Discusión sobre esta solicitud
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                  ...
                  {[
                    {
                      ...
                      fecha: 'Hace 1 día',
                      mensaje:
                        '¿Podrían especificar qué marcas de bolígrafos prefieren?'
                    },
                    {
                      id: 2,
                      usuario: 'Empresa ABC',
                    ...
                    },
                    {
                      ...
                      fecha: 'Hace 1 día',
                      mensaje:
                        '¿Cuál es el plazo máximo de entrega que considerarían aceptable?'
                    },
                    {
                      id: 4,
                      usuario: 'Empresa ABC',
                      ...
                      fecha: 'Hace 23 horas',
                      mensaje:
                        'Necesitamos los materiales en un plazo máximo de 7 días.'
                    }
                  ].map(comentario => (
