...
export default function ProveedorProfilePage() {
  ...
  const [, setActiveTab] = useState('ofertas')
    ...
    <div className='flex flex-col min-h-screen bg-background'>
      ...
      <header className='container-custom sticky top-0 z-50 flex items-center gap-2 p-4 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60'>
        ...
        <Button
          variant='ghost'
          size='icon'
          onClick={() => router.push('/dashboard/proveedor/settings')}
        >
      ...
      <main className='flex-1 container-custom max-w-4xl py-6 px-4'>
        <div className='space-y-8'>
              ...
              <div className='flex flex-col md:flex-row md:items-center gap-3 md:gap-6'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <Button
                    variant='outline'
                    size='sm'
                    onClick={() => router.push('/dashboard/proveedor/messages')}
                  >
              ...
              <div className='flex gap-6'>
                ...
                <div className='text-center'>
                  <p className='font-bold'>
                    {profile.stats.solicitudesSeguidas}
                  </p>
          ...
          <Card className='w-full'>
            <CardHeader className='pb-3'>
              ...
              <CardDescription>
                Desempeño general como proveedor
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                ...
                <div className='flex flex-col items-center justify-center p-3 rounded-lg bg-primary/10'>
                  ...
                  <p className='text-xl font-bold'>
                    {profile.stats.ofertasAceptadas}
                  </p>
                  <p className='text-xs text-muted-foreground'>
                    Ofertas aceptadas
                  </p>
            ...
            <TabsContent value='ofertas'>
              <div className='grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-4 mt-4'>
                {ofertas.map(oferta => (
                  <Link
                    key={oferta.id}
                    href={`/dashboard/solicitudes/${oferta.solicitudId}/proveedor`}
                  >
