...
export default function ProveedorNotificationsPage() {
  ...
  const notifications = [
    ...
    },
    {
      ...
      message:
        'Empresa ABC ha dejado una valoración de 5 estrellas para su servicio',
      empresa: 'Empresa ABC',
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    if (activeTab === 'activity')
      return ['new_review', 'new_request', 'delivery_confirmation'].includes(
        notification.type
      )
    return true
  })
  ...
  return (
    <div className='flex flex-col min-h-screen bg-background'>
      ...
      {/* Main content */}
      <main className='flex-1 container-custom max-w-2xl py-4 px-0'>
                      ...
                      <div className='flex items-center mt-2'>
                        <Avatar className='h-5 w-5 mr-1'>
                          <AvatarFallback className='text-xs'>
                            {notification.empresa.substring(0, 2)}
                          </AvatarFallback>
                        </Avatar>
          ...
          <TabsContent value='offers' className='mt-0'>
            ...
            {filteredNotifications.length > 0 ? (
              ...
              <div className='flex flex-col items-center justify-center py-12'>
                ...
                <p className='text-muted-foreground'>
                  No hay notificaciones de ofertas
                </p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value='messages' className='mt-0'>
            ...
            {filteredNotifications.length > 0 ? (
              ...
              <div className='flex flex-col items-center justify-center py-12'>
                ...
                <p className='text-muted-foreground'>
                  No hay notificaciones de mensajes
                </p>
              </div>
            )}
          </TabsContent>
