...
export const metadata: Metadata = {
  title: "SupplyConnect - Conectando Empresas con Proveedores de Manera Eficiente",
  description:
  ...
  keywords: "abastecimiento, proveedores, empresas, insumos, ofertas, gestión de compras, plataforma B2B",
}
        ...
        <div className="container px-4 md:px-6 relative z-10">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  SupplyConnect conecta empresas con proveedores en una plataforma intuitiva inspirada en redes
                  sociales, simplificando el proceso de abastecimiento y maximizando la eficiencia.
                </p>
              </div>
              ...
              <div className="relative w-full max-w-[500px] aspect-square rounded-xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-4/5 h-4/5 bg-card rounded-lg shadow-lg p-4 flex flex-col">
                    ...
                    <div className="text-sm font-medium">Solicitud: Materiales de oficina</div>
                    <div className="text-xs text-muted-foreground mb-3">Cantidad: 100 unidades</div>
                    <div className="mt-auto flex justify-between items-center">
                      <div className="text-xs text-muted-foreground">3 ofertas</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 bg-background/80 backdrop-blur-sm rounded-lg p-6 border">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <span className="text-sm text-muted-foreground">Solicitudes procesadas</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-3xl font-bold text-primary">$2M+</span>
              <span className="text-sm text-muted-foreground">En transacciones</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                SupplyConnect ofrece herramientas innovadoras para optimizar el proceso de abastecimiento, conectando
                empresas y proveedores de manera eficiente.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            <Card className="bg-background hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Las empresas pueden crear, publicar y gestionar solicitudes de insumos con detalles específicos,
                  plazos y requisitos personalizados.
                </p>
                <div className="pt-4">
                  <Link
            ...
            <Card className="bg-background hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Los proveedores pueden explorar solicitudes, enviar ofertas competitivas y destacar sus productos o
                  servicios a través de una interfaz intuitiva.
                </p>
                <div className="pt-4">
                  <Link
            ...
            <Card className="bg-background hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Sistema de mensajería integrado que permite una comunicación fluida entre empresas y proveedores para
                  negociar detalles y resolver dudas.
                </p>
                <div className="pt-4">
            ...
            <Card className="bg-background hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Potentes herramientas de búsqueda y filtrado que permiten encontrar rápidamente solicitudes o
                  proveedores según categorías, ubicación y otros criterios.
                </p>
                <div className="pt-4">
                  <Link href="#how-it-works" className="text-primary font-medium flex items-center hover:underline">
            ...
            <Card className="bg-background hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Diseño inspirado en redes sociales que facilita la navegación, interacción y gestión de solicitudes y
                  ofertas de manera sencilla e intuitiva.
                </p>
                <div className="pt-4">
                  <Link href="/login" className="text-primary font-medium flex items-center hover:underline">
            ...
            <Card className="bg-background hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Paneles de control con estadísticas detalladas sobre solicitudes, ofertas y transacciones para tomar
                  decisiones informadas y optimizar procesos.
                </p>
                <div className="pt-4">
                  <Link href="#how-it-works" className="text-primary font-medium flex items-center hover:underline">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Un proceso simple y eficiente para conectar empresas con proveedores, optimizando cada etapa del ciclo
                de abastecimiento.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-12 relative">
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Creación de Solicitud</h3>
                  <p className="text-muted-foreground">
                    Las empresas crean solicitudes detalladas especificando sus necesidades, cantidades, plazos y otros
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 md:text-left order-2 md:order-3">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Presentación de Ofertas</h3>
                  <p className="text-muted-foreground">
                    Los proveedores revisan las solicitudes y presentan sus ofertas detallando precios, condiciones,
                    plazos de entrega y valor agregado.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Comunicación y Negociación</h3>
                  <p className="text-muted-foreground">
                    Empresas y proveedores utilizan el sistema de mensajería integrado para aclarar dudas, negociar
                    términos y afinar detalles.
                  </p>
                </div>
                <div className="mx-auto md:mx-0 my-4 md:my-0 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-primary text-primary-foreground">
                  3
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 md:text-left order-2 md:order-3">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Selección de Oferta</h3>
                  <p className="text-muted-foreground">
                    La empresa evalúa todas las ofertas recibidas y selecciona la que mejor se adapta a sus necesidades,
                    considerando precio, calidad y plazos.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Entrega y Confirmación</h3>
                  <p className="text-muted-foreground">
                    El proveedor realiza la entrega según lo acordado y la empresa confirma la recepción, evaluando el
                    servicio y cerrando el ciclo.
                  </p>
                </div>
                <div className="mx-auto md:mx-0 my-4 md:my-0 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-primary text-primary-foreground">
                  5
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Descubra cómo SupplyConnect ha transformado los procesos de abastecimiento de empresas y proveedores.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center gap-4">
                  <Avatar className="h-12 w-12 border-2 border-secondary">
                    <AvatarImage src="/placeholder.svg?height=100&width=100" alt="María Rodríguez" />
                    <AvatarFallback>MR</AvatarFallback>
                  </Avatar>
                  <div>
                    <h4 className="font-semibold">María Rodríguez</h4>
                    <p className="text-sm text-muted-foreground">Gerente de Compras, TechSolutions</p>
                  </div>
                </div>
                ...
                <p className="italic text-muted-foreground">
                  "SupplyConnect ha revolucionado nuestra forma de gestionar las compras. Hemos reducido los tiempos de
                  adquisición en un 40% y encontrado proveedores de mayor calidad. La interfaz intuitiva hace que todo
                  el proceso sea extremadamente sencillo."
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background hover:shadow-md transition-shadow">
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center gap-4">
                  <Avatar className="h-12 w-12 border-2 border-secondary">
                    <AvatarImage src="/placeholder.svg?height=100&width=100" alt="Carlos Méndez" />
                    <AvatarFallback>CM</AvatarFallback>
                  </Avatar>
                  <div>
                    <h4 className="font-semibold">Carlos Méndez</h4>
                    <p className="text-sm text-muted-foreground">Director, Suministros Industriales</p>
                  </div>
                </div>
                <div className="flex space-x-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                ...
                <p className="italic text-muted-foreground">
                  "Como proveedor, SupplyConnect nos ha abierto puertas a nuevos clientes que no habríamos encontrado
                  por otros medios. La plataforma nos permite mostrar nuestros productos de manera efectiva y
                  comunicarnos directamente con las empresas interesadas."
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background hover:shadow-md transition-shadow">
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center gap-4">
                  <Avatar className="h-12 w-12 border-2 border-secondary">
                    <AvatarImage src="/placeholder.svg?height=100&width=100" alt="Ana Gómez" />
                ...
                <p className="italic text-muted-foreground">
                  "Implementar SupplyConnect en nuestra empresa ha sido una de las mejores decisiones estratégicas.
                  Hemos optimizado nuestro proceso de abastecimiento, reducido costos y mejorado la calidad de nuestros
                  proveedores. Totalmente recomendado."
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            <div className="bg-background rounded-lg p-6 border text-center">
              ...
              <p className="text-muted-foreground">de satisfacción de usuarios</p>
            </div>
            <div className="bg-background rounded-lg p-6 border text-center">
              <div className="text-4xl font-bold text-primary mb-2">30%</div>
              <p className="text-muted-foreground">de reducción en tiempos de adquisición</p>
            </div>
            <div className="bg-background rounded-lg p-6 border text-center">
              <div className="text-4xl font-bold text-primary mb-2">25%</div>
              <p className="text-muted-foreground">de ahorro promedio en costos</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-muted-foreground mb-6">
                SupplyConnect nació en 2020 con una misión clara: revolucionar la forma en que las empresas y
                proveedores se conectan y realizan transacciones. Identificamos que los procesos tradicionales de
                abastecimiento eran ineficientes, costosos y carecían de transparencia.
              </p>
              <p className="text-muted-foreground mb-6">
                Nuestra plataforma combina la potencia de la tecnología moderna con una interfaz inspirada en redes
                sociales para crear una experiencia intuitiva y eficiente. Estamos comprometidos con la innovación
                continua y la satisfacción de nuestros usuarios.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Simplificar y optimizar los procesos de abastecimiento empresarial, conectando empresas y
                      proveedores de manera eficiente y transparente.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Convertirnos en la plataforma líder de abastecimiento B2B a nivel global, transformando la manera
                      en que las empresas gestionan sus cadenas de suministro.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Innovación, transparencia, eficiencia, colaboración y compromiso con la excelencia en cada aspecto
                      de nuestra plataforma y servicio.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="md:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-muted rounded-lg p-4 text-center">
                  <h4 className="font-bold text-2xl text-primary">2020</h4>
                  <p className="text-sm text-muted-foreground">Año de fundación</p>
                </div>
                <div className="bg-muted rounded-lg p-4 text-center">
                  <h4 className="font-bold text-2xl text-primary">35+</h4>
                  <p className="text-sm text-muted-foreground">Profesionales en el equipo</p>
                </div>
                <div className="bg-muted rounded-lg p-4 text-center">
                  <h4 className="font-bold text-2xl text-primary">12</h4>
                  <p className="text-sm text-muted-foreground">Países con presencia</p>
                </div>
                <div className="bg-muted rounded-lg p-4 text-center">
                  <h4 className="font-bold text-2xl text-primary">3</h4>
                  <p className="text-sm text-muted-foreground">Premios de innovación</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Únase a SupplyConnect y experimente una nueva forma de gestionar sus insumos y conectar con empresas y
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row gap-12">
            <div className="md:w-1/2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-4">¿Necesita más información?</h2>
              <p className="text-muted-foreground mb-6">
                Estamos aquí para responder todas sus preguntas y ayudarle a aprovechar al máximo nuestra plataforma.
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">info@supplyconnect.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">www.supplyconnect.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <Link href="#" className="rounded-full bg-muted p-2 hover:bg-muted/80 transition-colors">
                ...
                <CardContent className="p-6">
                  <form className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="subject" placeholder="¿En qué podemos ayudarle?" />
                    </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-2/3">
              <h3 className="text-2xl font-bold mb-2">Suscríbase a nuestro boletín</h3>
              <p className="text-muted-foreground">
                Reciba las últimas noticias, actualizaciones y consejos sobre gestión de abastecimiento.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Plataforma innovadora que conecta empresas con proveedores de manera eficiente y transparente.
              </p>
              <div className="flex space-x-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} SupplyConnect. Todos los derechos reservados.
            </p>
